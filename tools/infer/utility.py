...
def init_args():
    ...
    parser.add_argument("--det_model_dir", type=str, default='ch_PP-OCRv2_det_infer/')
    ...
    parser.add_argument("--rec_model_dir", type=str, default='ch_PP-OCRv2_rec_infer/')
    ...
    parser.add_argument("--cls_model_dir", type=str, default='ch_ppocr_cls_infer/')
